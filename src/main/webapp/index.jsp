...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Ayu...Dev...</a>
			<button
	...
	<header class="masthead text-white text-center"
		style="background-color: #0f59a753;">
		...
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h6 class="masthead-heading text-uppercase mb-0">Welcome to
				Ayu.. World! Explore our Java and Web Development services with
				passion.</h6>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/portfolio1.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 2-->
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/portfolio2.avif"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 3-->
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/portfolio3.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 4-->
				<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/portfolio5.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 5-->
				<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/portfolio6.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 6-->
				<div class="col-md-6 col-lg-4">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/portfolio7.jpeg"
							alt="..." />
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Lorem ipsum dolor, sit amet consectetur
						adipisicing elit. Sed eveniet quaerat odit at deserunt. Dolorem
						quod quas laboriosam. Laudantium, repudiandae?</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Lorem ipsum dolor sit amet consectetur
						adipisicing elit. Rem eos autem a officia. Omnis fugit et at
						perferendis quidem dolore!</p>
				</div>
			</div>
	...
	<footer class="footer text-center">
		<div class="container">
			<div class="row">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About This Wbsite</h4>
					<p class="lead mb-0">
						If you wanted to know more ples... <a href="#">Contact Us😎</a>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Ayu...Your Website 2024</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
